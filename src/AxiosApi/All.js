...
export default class All extends Component {
  ...
  changeData = (e) => {
    // form is non editable for editing purpose we have taken this method at first when we bind the state
    this.setState({
  ...
  editData(id) {
    //edit method  for getting the data to  the form when we  click the update button
    axios
  ...
  submitHandler = (e) => {
    ...
    e.preventDefault();
      ...
      axios
        .put(`http://localhost:4000/employees/${id}`, { id, name, salary })
        .then((res) => {
    ...
    //   axios
    //     .post("http://localhost:4000/employees", { id, name, salary })
    //     .then((res) => {
